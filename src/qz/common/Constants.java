...
public class Constants {
    ...
    public static final String ABOUT_TITLE = "EQHALI - QZ Tray";
    public static final String ABOUT_URL = "https://www.minsa.gob.pe";
    public static final String ABOUT_COMPANY = "MINSA & QZ Industries, LLC";
    public static final String ABOUT_OWNER = "HerlesINC - herles.incalla@gmail.com";
